<div align="center">
  <img src="assets/Echo-new.png" alt="Echoora Logo" width="140"/>
  ...
  <a href="https://Echoora.fun/download">
    <img src="assets/download.png" alt="Download" width="180"/>
  </a>
  &nbsp;
  <a href="https://Echoora.fun/obtainium">
...
Echoora delivers a seamless, premium listening experience by leveraging YouTube Music's vast library — without the ads. It adds powerful extras including offline downloads, real-time synchronized lyrics, and environment-aware music recognition.
...
### What's New
- **Lossless Music Hub** — Stream and contribute 16-bit/24-bit FLAC files directly to the Echoora ecosystem.
...
4. **Build the Application**
   Echoora has two build variants: **FOSS** (without Google Play Services / Cast) and **GMS** (with Cast support).
...
<h3>We use Weblate to translate Echoora. <a href="https://hosted.weblate.org/projects/echo-music/">Help us bring Echoora to more people!</a></h3>
...
If Echoora has been useful to you, consider supporting its development.
...
Echoora stands on the shoulders of several excellent open-source projects. Sincere thanks to:
