...
If you discover a security vulnerability in Echoora, please report it responsibly:

1. **Do NOT** create a public GitHub issue
2. Email us at: [security@Echoora.fun](mailto:security@Echoora.fun)
...
Echoora is committed to user privacy:
...
- Email: [security@Echoora.fun](mailto:security@Echoora.fun)
- GitHub: Create a private security advisory

Thank you for helping keep Echoora secure!
